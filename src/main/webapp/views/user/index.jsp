			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-xl-4 col-lg-6">
						<div class="single-category mb-30">
							<div class="category-img">
								<img src="<c:url value='assets/user/img/categori/cat1.jpg'/>"
									alt="">
					...
					<div class="col-xl-4 col-lg-6">
						<div class="single-category mb-30">
							<div class="category-img text-center">
								<img src="<c:url value='assets/user/img/categori/cat2.jpg'/>"
									alt="">
								<div class="category-caption">
					...
					<div class="col-xl-4 col-lg-6">
						<div class="single-category mb-30">
							<div class="category-img">
								<img src="<c:url value='assets/user/img/categori/cat3.jpg'/>"
									alt="">
								<div class="category-caption">
									<h2>Man`s Cloth</h2>
									<span class="best"><a href="#">Best New Deals</a></span> <span
						...
						<div class="row">
							<div class="col-xl-4 col-lg-4 col-md-6">
								<div class="single-product mb-60">
									<div class="product-img">
										<img
											src="<c:url value='assets/user/img/categori/product1.png'/>"
											alt="">
							...
							<div class="col-xl-4 col-lg-4 col-md-6">
								<div class="single-product mb-60">
									<div class="product-img">
										<img
											src="<c:url value='assets/user/img/categori/product2.png'/>"
											alt="">
									</div>
									<div class="product-caption">
										<div class="product-ratting">
							...
							<div class="col-xl-4 col-lg-4 col-md-6">
								<div class="single-product mb-60">
									<div class="product-img">
										<img
											src="<c:url value='assets/user/img/categori/product3.png'/>"
											alt="">
										<div class="new-product">
											<span>New</span>
										</div>
